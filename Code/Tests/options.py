...
class Options():
    ...
    @staticmethod
    def get_default():
    # def get_default(self):   # 05.17进行更改，因为报错为缺少self，所以使用装饰器改为静态方法（通义建议）
        opt = {}
